...
const Checkout = (() => {
  ...
  // ── YOUR CONFIG ──────────────────────────────────────────────
  const RAZORPAY_KEY_ID = 'rzp_live_Sczvk68iCuryMo';
  const GAS_URL         = 'https://script.google.com/macros/s/AKfycbzHCMUVrJLTQqvPZSHxDH6NGojIlW-zB4wU_oRfCGq93AwKqfoeq3xXzgktdtoD5dVp/exec';
